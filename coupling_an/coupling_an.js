...
lib.ssMetadata = [
		{name:"coupling_an_atlas_1", frames: [[475,690,74,57],[236,844,129,83],[473,631,79,57],[236,929,129,83],[475,749,74,57],[379,746,94,83],[551,690,49,57],[367,916,76,83],[387,679,84,57],[248,746,129,83],[445,916,109,57],[367,831,129,83],[460,437,26,192],[230,410,155,334],[498,808,53,57],[387,606,71,71],[0,844,120,167],[0,410,228,332],[122,844,112,167],[429,0,228,435],[387,437,43,167],[0,0,427,408],[0,746,246,96]]}
];
...
(lib.CachedBmp_24 = function() {
	this.initialize(ss["coupling_an_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.coupling_an = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/coupling_an_atlas_1.png?1692455008398", id:"coupling_an_atlas_1"}
	],
	preloads: []
};

...
lib.ssMetadata = [
		{name:"coupling_therm_atlas_1", frames: [[238,620,74,57],[895,338,129,83],[157,620,79,57],[889,423,129,83],[314,620,74,57],[288,535,94,83],[390,620,49,57],[384,535,76,83],[462,608,84,57],[889,508,129,83],[889,593,109,57],[157,535,129,83],[611,437,26,192],[0,410,155,334],[548,606,53,57],[462,535,71,71],[895,0,120,167],[659,371,228,332],[895,169,112,167],[429,0,228,435],[566,437,43,167],[0,0,427,408],[659,0,234,369],[157,437,407,96]]}
];
...
(lib.CachedBmp_24 = function() {
	this.initialize(ss["coupling_therm_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.coupling_therm = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_1 = function() {
		...
		this.pump = function(){
			...
			createjs.Tween.get(p).to({x:200,y:455},this.fadeTime/2).to({y:280}).to({x:this.randx(),y:this.randy_u()},this.fadeTime/2).call(this.therm);
			this.out_protons.push(p);
			this.in_protons.splice(pind,1);
		}
		this.therm = function() {
			console.log('therm');
			pind = Math.floor(Math.random()*this.parent.out_protons.length);
			p = this.parent.out_protons[pind];
			createjs.Tween.get(p).to({x:674,y:265},this.parent.fadeTime).to({y:466}).to({x:this.parent.randx(),y:this.parent.randy_l()},this.parent.fadeTime/2);
			this.parent.in_protons.push(p);
			this.parent.out_protons.splice(pind,1);
		}
		this.etc = function() {
	...
	this.instance.setTransform(620.45,275.55,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_1();
	this.instance_1.setTransform(22,14.65,0.5,0.5);
	...
	this.instance_2.setTransform(483.7,368);

	this.instance_3 = new lib.Symbol1("synched",1);
	this.instance_3.setTransform(336.7,368);

	this.instance_4 = new lib.Symbol1("synched",0);
	this.instance_4.setTransform(141.3,368);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.atpenz}]},1).wait(1));
	this.atpenz.addEventListener("tick", AdobeAn.handleFilterCache);

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#6633FF").ss(14,0,1).p("EhP/gJpMCf/AAAEBQAAJqMif/AAA");
...
p.nominalBounds = new cjs.Rectangle(0,0,1031,586.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/coupling_therm_atlas_1.png?1692523202694", id:"coupling_therm_atlas_1"}
	],
	preloads: []
};

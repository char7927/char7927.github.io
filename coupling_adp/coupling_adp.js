...
lib.ssMetadata = [
		{name:"coupling_adp_atlas_1", frames: [[494,724,74,57],[236,844,129,83],[460,665,79,57],[277,746,129,83],[498,783,74,57],[367,916,94,83],[432,496,49,57],[463,916,76,83],[408,738,84,57],[236,929,129,83],[387,606,109,57],[367,831,129,83],[498,437,26,192],[230,410,155,334],[432,437,53,57],[387,665,71,71],[0,844,120,167],[0,410,228,332],[122,844,112,167],[429,0,228,435],[387,437,43,167],[0,0,427,408],[0,746,275,96]]}
];
...
(lib.CachedBmp_24 = function() {
	this.initialize(ss["coupling_adp_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.coupling_adp = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/coupling_adp_atlas_1.png?1692455135749", id:"coupling_adp_atlas_1"}
	],
	preloads: []
};

...
lib.ssMetadata = [
		{name:"accel_check_partner_mo_atlas_1", frames: [[0,452,986,96],[452,278,50,137],[452,0,59,137],[452,139,57,137],[0,0,450,450]]}
];
...
(lib.CachedBmp_4 = function() {
	this.initialize(ss["accel_check_partner_mo_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.accel_check_partner_mo = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_1 = function() {
		...
		this.moveMe= function(m_obj) {
			this.pha.rotation = m_obj.accel_x;
			this.phb.rotation = m_obj.accel_y;
			this.phg.rotation = m_obj.accel_z;
		}
		establishWS();
	...
	this.instance.setTransform(802.1,482.45,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_2();
	this.instance_1.setTransform(497.35,482.45,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_1();
	this.instance_2.setTransform(195.05,482.45,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/accel_check_partner_mo_atlas_1.png?1693771607993", id:"accel_check_partner_mo_atlas_1"}
	],
	preloads: []
};
